  ...
  export interface IServiceVesselCreateResponse {
    status?: number;
    message?: string;
    vessel?: IVessel | null;
    errors?: { [key: string]: any };
  }
  export interface IServiceVesselUpdateResponse {
    status?: number;
    message?: string;
    data?:{
      vessel?: IVessel | null;
...
export interface IServiceVesselGetAllResponse {
    status?: number;
    message?: string;
    vessels?: IVessel[] | null;
    errors?: { [key: string]: any };
}
