  ...
  return !session.data &&
    <>
      <Head>
        ...
        <meta name='title' content='Om-Training | Login' />
        <meta
          name='description'
          content='This is NOT REAL Om-Training! This site created for educational purposes only.'
        />

        <meta property='og:type' content='website' />
        <meta property='og:title' content='Om-Training | Login' />
        ...
        <main className='flex flex-row items-center justify-center w-full flex-shrink-0 flex-grow pb-8 h-[90%]'>
          <div className='flex flex-col flex-grow justify-center max-w-[350px]'>
              ...
              <form className=' items-center bg-white box-border flex flex-col flex-shrink-0 py-[10px] px-9 relative align-baseline'>
                <p className='font-grandista text-4xl opacity-90 my-10'>OM-Training</p>
                <Input
                        id="email"
                        label="Email"
                        disabled={isLoading}
